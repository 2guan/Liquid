...
const THEME: Record<ModeId, { wash: [string, string]; glow: string; glass: string; family: string; ice: string; fill: number; fizzy?: boolean; garnish?: string[] }> = {
  ...
  mood: { wash: ["#2c3656", "#11162a"], glow: "#8AA0D8", glass: "highball", family: "cranberry", ice: "cube", fill: 0.92, garnish: ["迷迭香", "食用花"] },

 ...
 *
 * Shared verbatim between the web app and the mini-program (only import paths
 * differ), so the two stay perfectly in sync.
 */
...
export const BADGES: Badge[] = [
  ...
  b("vol_500", "volume", "千杯不倒", "Unshakable", "累计调制 500 杯", "legend", 500, (s) => s.pours),

  // ── 纯饮 ──
  b("pure_1", "pure", "纯饮初心", "Neat Start", "完成 1 杯纯饮", "bronze", 1, (s) => s.pure),
  b("pure_10", "pure", "独饮者", "The Solitary Sip", "完成 10 杯纯饮", "silver", 10, (s) => s.pure),
  b("pure_30", "pure", "纯饮行家", "Connoisseur", "完成 30 杯纯饮", "gold", 30, (s) => s.pure),
  b("pure_75", "pure", "纯饮宗师", "Pure Master", "完成 75 杯纯饮", "legend", 75, (s) => s.pure),
  ...
  b("mix_30", "mixology", "配方行家", "Recipe Adept", "复刻 30 杯经典", "gold", 30, (s) => s.mixology),
  b("mix_75", "mixology", "经典守护者", "Keeper of Classics", "复刻 75 杯经典", "legend", 75, (s) => s.mixology),
  ...
  b("mood_30", "mood", "心事收集者", "Heart Collector", "倾诉 30 次心情", "gold", 30, (s) => s.mood),
  b("mood_75", "mood", "共情大师", "The Empath", "倾诉 75 次心情", "legend", 75, (s) => s.mood),

  // ── 魔法 ──
  b("zen_1", "zen", "初探魔法", "First Spark", "自由调配 1 次", "bronze", 1, (s) => s.zen),
  b("zen_10", "zen", "自由调配", "Free Mixer", "自由调配 10 次", "silver", 10, (s) => s.zen),
  b("zen_30", "zen", "炼金行家", "Alchemy Adept", "自由调配 30 次", "gold", 30, (s) => s.zen),
  b("zen_75", "zen", "炼金宗师", "Grand Alchemist", "自由调配 75 次", "legend", 75, (s) => s.zen),
  ...
  b("color_15", "color", "风味光谱", "Full Spectrum", "调出 15 种色系", "legend", 15, (s) => s.families),
  ...
  b("secret_3", "secret", "秘方专家", "Secret Adept", "解锁 3 个隐藏配方", "gold", 3, (s) => s.unlocked),
  b("secret_4", "secret", "秘方全集", "All Secrets", "解锁全部隐藏配方", "legend", 4, (s) => s.unlocked),

...
export const RECIPE_CATEGORIES: RecipeCategoryMeta[] = [
  { id: "golden", name: "黄金时代", nameEn: "Golden Age", era: "1860–1919", accent: "#C8A45D" },
  { id: "prohibition", name: "禁酒年代", nameEn: "Prohibition Era", era: "1920–1933", accent: "#9C5A33" },
  { id: "tiki", name: "提基风潮", nameEn: "Tiki & Tropical", era: "1934–1970", accent: "#D89C3A" },
  { id: "modern", name: "现代精酿", nameEn: "Modern Craft", era: "1990–至今", accent: "#7E8C4E" },
  { id: "zero", name: "无酒精特调", nameEn: "Zero-Proof", era: "不含酒精", accent: "#8FB0C4" },
];

const ICES = new Set<IceType>(["none", "sphere", "cube", "crushed"]);
...
const RAW: Record<RecipeCategory, Row[]> = {
  golden: [
    ...
    ["曼哈顿", "Manhattan", "coupe", "none", "whisky", 2, "黑麦威士忌^60ml;甜味美思^30ml;安格仕苦精^2 dash;马拉斯加樱桃^1 颗", "醇厚饱满，黑麦的辛香与味美思交织"],
    ...
    ["汤姆柯林斯", "Tom Collins", "highball", "cube", "gin", 1, "金酒^45ml;柠檬汁^25ml;糖浆^15ml;苏打水^顶部补满", "气泡柠檬汽水，清爽悠长"],
    ["金菲兹", "Gin Fizz", "highball", "none", "gin", 2, "金酒^45ml;柠檬汁^25ml;糖浆^15ml;蛋白^1 个;苏打水^顶部补满", "云雾般绵密，柠檬与气泡的清晨"],
    ...
    ["血与沙", "Blood and Sand", "coupe", "none", "whisky", 2, "苏格兰威士忌^22ml;甜味美思^22ml;樱桃利口酒^22ml;橙汁^22ml", "等比四味，血橙色的银幕浪漫"],
    ...
    ["香槟鸡尾酒", "Champagne Cocktail", "coupe", "none", "wine", 1, "香槟^120ml;方糖^1 颗;安格仕苦精^2 dash", "气泡升腾，方糖在杯底缓缓融化"],
    ["法兰西75", "French 75", "coupe", "none", "gin", 2, "金酒^30ml;柠檬汁^15ml;糖浆^10ml;香槟^顶部补满", "金酒酸酒遇上香槟，如炮火般明亮"],
    ...
    ["美国佬", "Americano", "highball", "cube", "campari", 1, "金巴利^30ml;甜味美思^30ml;苏打水^顶部补满", "尼格罗尼去金酒，清爽的苦甜开胃"],
    ...
    ["金瑞奇", "Gin Rickey", "highball", "cube", "gin", 1, "金酒^60ml;青柠汁^15ml;苏打水^顶部补满", "无糖的清爽，青柠与气泡的纯粹"],
  ...
  prohibition: [
    ...
    ["粉红佳人", "Pink Lady", "coupe", "none", "gin", 2, "金酒^45ml;苹果白兰地^15ml;红石榴糖浆^10ml;柠檬汁^15ml;蛋白^1 个", "玫瑰色泡沫，复古的优雅"],
    ...
    ["航空邮件", "Air Mail", "coupe", "none", "rum", 2, "金朗姆^45ml;蜂蜜糖浆^15ml;青柠汁^15ml;香槟^顶部补满", "蜂蜜朗姆遇香槟，气泡升空"],
    ...
    ["响尾蛇", "Diamondback", "coupe", "none", "whisky", 2, "黑麦威士忌^45ml;苹果白兰地^22ml;黄查特酒^22ml", "强劲草本，禁酒令的危险之美"],
    ["野蛮海岸", "Barbary Coast", "coupe", "none", "gin", 2, "金酒^22ml;苏格兰威士忌^22ml;可可利口酒^22ml;鲜奶油^22ml", "旧金山红灯区，烟熏可可奶油"],
    ["古巴自由", "Cuba Libre", "highball", "cube", "rum", 1, "金朗姆^50ml;可乐^顶部补满;青柠角^1 块", "朗姆可乐加青柠，自由的气泡"],
    ["玛梅泰勒", "Mamie Taylor", "highball", "cube", "whisky", 1, "苏格兰威士忌^50ml;姜啤^顶部补满;青柠汁^15ml", "苏格兰版骡子，姜的辛辣"],
    ["军舰", "Navy Sour", "coupe", "none", "rum", 2, "海军朗姆^50ml;青柠汁^25ml;德梅拉拉糖浆^15ml", "高强度朗姆的酸酒，浓烈甘醇"],
    ["白色蜘蛛", "White Spider", "coupe", "none", "vodka", 1, "伏特加^45ml;薄荷利口酒^30ml", "伏特加版螫刺，冰凉透明"],
    ["金汤力", "Gin & Tonic", "highball", "cube", "gin", 1, "金酒^50ml;汤力水^顶部补满;青柠角^1 块", "金鸡纳的微苦与杜松，殖民地的清凉"],
    ["秀兰邓波尔成人版", "Adult Shirley", "highball", "cube", "vodka", 1, "伏特加^45ml;红石榴糖浆^15ml;姜汁汽水^顶部补满;樱桃^1 颗", "童年汽水的成人改写"],
    ...
    ["玉兰", "Magnolia", "coupe", "none", "gin", 2, "金酒^45ml;柠檬汁^15ml;橙汁^15ml;蛋白^1 个;香槟^少量", "花名鸡尾酒，柑橘泡沫的优雅"],
    ...
    ["第八病房", "Ward Eight", "coupe", "none", "whisky", 2, "黑麦威士忌^60ml;柠檬汁^15ml;橙汁^15ml;红石榴糖浆^10ml", "波士顿政坛之名，威士忌的果香酸甜"],
    ["金雏菊", "Gin Daisy", "rocks", "crushed", "gin", 1, "金酒^50ml;柠檬汁^22ml;红石榴糖浆^15ml;苏打水^少量", "禁酒令前的雏菊家族，碎冰果香"],
    ["狮尾", "Lion's Tail", "coupe", "none", "whisky", 2, "波本威士忌^60ml;多香果利口酒^15ml;青柠汁^15ml;糖浆^7.5ml;苦精^2 dash", "多香果的异域香料，温暖辛甜"],
    ["布朗德比", "Brown Derby", "coupe", "none", "whisky", 1, "波本威士忌^60ml;西柚汁^22ml;蜂蜜糖浆^15ml", "好莱坞名店之作，葡萄柚蜂蜜"],
  ...
  tiki: [
    ["迈泰", "Mai Tai", "rocks", "crushed", "rum", 2, "牙买加朗姆^30ml;农业朗姆^30ml;君度橙酒^15ml;杏仁糖浆^15ml;青柠汁^30ml", "提基之王，朗姆与杏仁青柠的天堂"],
    ...
    ["土星", "Saturn", "coupe", "crushed", "gin", 2, "金酒^45ml;百香果糖浆^15ml;柠檬汁^15ml;杏仁糖浆^7.5ml;法勒纳姆^7.5ml", "金酒提基的稀有之作，百香果芳香"],
    ["飓风", "Hurricane", "highball", "crushed", "rum", 1, "金朗姆^30ml;黑朗姆^30ml;百香果糖浆^30ml;柠檬汁^30ml", "新奥尔良的飓风杯，热带果潘趣"],
    ["新加坡司令", "Singapore Sling", "highball", "cube", "gin", 3, "金酒^30ml;樱桃利口酒^15ml;君度橙酒^7.5ml;修士酒^7.5ml;菠萝汁^60ml;青柠汁^15ml;红石榴糖浆^7.5ml;苦精^1 dash", "莱佛士酒店之魂，复杂热带果香"],
    ["种植者潘趣", "Planter's Punch", "highball", "crushed", "rum", 1, "黑朗姆^60ml;橙汁^30ml;菠萝汁^30ml;青柠汁^15ml;红石榴糖浆^7.5ml", "牙买加古训：一酸二甜三烈四弱"],
    ["试飞员", "Test Pilot", "coupe", "crushed", "rum", 3, "金朗姆^45ml;海军朗姆^22ml;君度橙酒^7.5ml;法勒纳姆^7.5ml;青柠汁^15ml;苦精^2 dash", "Don the Beachcomber 杰作，烈而平衡"],
    ...
    ["蓝色夏威夷", "Blue Hawaii", "highball", "crushed", "rum", 1, "白朗姆^30ml;伏特加^15ml;蓝橙利口酒^15ml;菠萝汁^60ml;甜酸^30ml", "亮蓝海洋色，菠萝热带风情"],
    ["眼镜蛇之牙", "Cobra's Fang", "highball", "crushed", "rum", 2, "黑朗姆^45ml;海军朗姆^15ml;百香果糖浆^15ml;橙汁^22ml;青柠汁^15ml;茴香^1 dash", "Don 的香料毒牙，深色而辛香"],
    ["港口之光", "Port Light", "coupe", "crushed", "whisky", 2, "波本威士忌^45ml;百香果糖浆^22ml;蜂蜜^15ml;柠檬汁^22ml;红石榴糖浆^7.5ml;蛋白^1 个", "波本提基，百香果的明亮"],
    ["受苦的混蛋", "Suffering Bastard", "highball", "cube", "gin", 1, "金酒^30ml;白兰地^30ml;青柠汁^15ml;苦精^2 dash;姜啤^顶部补满", "开罗解宿醉名作，姜的辛辣"],
    ["皇家夏威夷", "Royal Hawaiian", "coupe", "none", "gin", 1, "金酒^45ml;菠萝汁^30ml;柠檬汁^15ml;杏仁糖浆^7.5ml", "菠萝杏仁的轻盈热带马天尼"],
    ["黑暗风暴", "Dark 'n' Stormy", "highball", "cube", "rum", 1, "黑朗姆^60ml;姜啤^顶部补满;青柠角^1 块", "百慕大的乌云风暴，姜与黑朗姆"],
    ...
    ["蓝色泻湖", "Blue Lagoon", "highball", "cube", "vodka", 1, "伏特加^45ml;蓝橙利口酒^22ml;柠檬汽水^顶部补满", "电光蓝的清凉，柑橘汽水"],
    ["可可滩", "Cocoa Beach", "highball", "crushed", "rum", 1, "椰子朗姆^45ml;菠萝汁^45ml;蔓越莓汁^30ml;青柠汁^15ml", "椰子与莓果的沙滩午后"],
    ["毛伊酒杯", "Maui Mule", "highball", "crushed", "vodka", 1, "伏特加^45ml;菠萝汁^30ml;青柠汁^15ml;姜啤^顶部补满", "热带版莫斯科骡子，姜菠萝"],
    ["波利尼西亚", "Polynesian", "coupe", "crushed", "rum", 2, "白朗姆^45ml;百香果糖浆^15ml;青柠汁^22ml;盐边^适量", "海岛酸甜，百香果的明媚"],
    ...
    ["珊瑚之吻", "Coral Kiss", "coupe", "crushed", "rum", 1, "白朗姆^45ml;荔枝利口酒^15ml;青柠汁^15ml;椰子奶油^15ml", "荔枝椰子的柔软海岛吻"],
  ...
  modern: [
    ["盘尼西林", "Penicillin", "rocks", "sphere", "whisky", 2, "调和苏格兰^60ml;蜂蜜姜糖浆^22ml;柠檬汁^22ml;泥煤威士忌^7.5ml 漂浮", "现代经典，蜂蜜姜与烟熏的良药"],
    ["纸飞机", "Paper Plane", "coupe", "none", "whisky", 2, "波本威士忌^22ml;阿佩罗^22ml;阿玛罗^22ml;柠檬汁^22ml", "等比四味的现代杰作，苦甜平衡"],
    ["裸体与名声", "Naked and Famous", "coupe", "none", "tequila", 2, "梅斯卡尔^22ml;黄查特酒^22ml;阿佩罗^22ml;青柠汁^22ml", "烟熏版临别赠言，等比的危险魅力"],
    ["淘金热", "Gold Rush", "rocks", "sphere", "whisky", 1, "波本威士忌^60ml;蜂蜜糖浆^22ml;柠檬汁^22ml", "威士忌酸酒的蜂蜜进化，圆润浓郁"],
    ["大都会", "Cosmopolitan", "martini", "none", "vodka", 1, "柑橘伏特加^45ml;君度橙酒^15ml;蔓越莓汁^30ml;青柠汁^15ml", "都市女郎的粉红，蔓越莓清爽"],
    ["浓缩咖啡马天尼", "Espresso Martini", "martini", "none", "vodka", 2, "伏特加^45ml;咖啡利口酒^15ml;浓缩咖啡^30ml;糖浆^7.5ml", "提神又微醺，咖啡油脂的奶泡"],
    ["黑莓荆棘", "Bramble", "rocks", "crushed", "gin", 1, "金酒^50ml;柠檬汁^25ml;糖浆^12ml;黑莓利口酒^15ml", "碎冰上的黑莓渗染，伦敦现代经典"],
    ["玛格丽特", "Margarita", "coupe", "none", "tequila", 1, "龙舌兰^50ml;君度橙酒^25ml;青柠汁^25ml;盐边^适量", "咸口起兴，龙舌兰青草与青柠"],
    ["汤米玛格丽特", "Tommy's Margarita", "rocks", "cube", "tequila", 1, "龙舌兰^60ml;青柠汁^30ml;龙舌兰糖浆^15ml", "无橙酒的纯净，龙舌兰本味"],
    ["莫斯科骡子", "Moscow Mule", "highball", "cube", "vodka", 1, "伏特加^50ml;青柠汁^15ml;姜啤^顶部补满;青柠角^1 块", "铜杯里的辛辣气泡，清爽提神"],
    ["长岛冰茶", "Long Island Iced Tea", "highball", "cube", "vodka", 2, "伏特加^15ml;金酒^15ml;白朗姆^15ml;龙舌兰^15ml;君度橙酒^15ml;柠檬汁^22ml;可乐^顶部补满", "五烈酒伪装的茶色，强劲危险"],
    ["茉莉", "Jasmine", "coupe", "none", "gin", 2, "金酒^45ml;金巴利^7.5ml;君度橙酒^7.5ml;柠檬汁^15ml", "西柚般的苦甜花香，现代酸酒"],
    ["分界钟", "Division Bell", "coupe", "none", "tequila", 2, "梅斯卡尔^45ml;阿佩罗^22ml;黑樱桃利口酒^15ml;青柠汁^22ml", "烟熏与苦橙樱桃的现代平衡"],
    ["瓦哈卡古典", "Oaxaca Old Fashioned", "rocks", "sphere", "tequila", 2, "龙舌兰^45ml;梅斯卡尔^15ml;龙舌兰糖浆^7.5ml;苦精^2 dash", "烟熏版古典，墨西哥的深沉"],
    ["特立尼达酸酒", "Trinidad Sour", "coupe", "none", "whisky", 3, "安格仕苦精^45ml;杏仁糖浆^30ml;黑麦威士忌^15ml;柠檬汁^22ml", "以苦精为基酒的颠覆之作"],
    ["金酒罗勒击打", "Gin Basil Smash", "rocks", "crushed", "gin", 1, "金酒^60ml;柠檬汁^25ml;糖浆^15ml;罗勒叶^10 片", "罗勒拍打出的翠绿清香，德式现代"],
    ["东区", "Eastside", "coupe", "none", "gin", 1, "金酒^60ml;青柠汁^22ml;糖浆^22ml;黄瓜片^3 片;薄荷叶^6 片", "黄瓜薄荷的清新南区变奏"],
    ["辣味玛格丽特", "Spicy Margarita", "rocks", "cube", "tequila", 2, "龙舌兰^50ml;君度橙酒^15ml;青柠汁^25ml;辣椒^2 片;辣盐边^适量", "辣椒点燃的玛格丽特，热情似火"],
    ["阿佩罗气泡", "Aperol Spritz", "highball", "cube", "campari", 1, "阿佩罗^60ml;普罗赛克^90ml;苏打水^少量;橙片^1 片", "威尼斯的橙色午后，微苦气泡"],
    ["雨果气泡", "Hugo Spritz", "highball", "cube", "wine", 1, "接骨木花利口酒^30ml;普罗赛克^90ml;苏打水^少量;薄荷^适量;青柠^适量", "接骨木薄荷的清新气泡"],
    ["加里波第", "Garibaldi", "highball", "cube", "campari", 1, "金巴利^60ml;鲜榨橙汁^120ml", "蓬松橙汁裹苦橙，简单而惊艳"],
    ["血腥玛丽", "Bloody Mary", "highball", "cube", "vodka", 2, "伏特加^45ml;番茄汁^90ml;柠檬汁^15ml;辣酱^3 dash;伍斯特酱^2 dash;芹菜^1 根", "咸鲜辛辣的早午餐救赎"],
    ...
    ["色情明星马天尼", "Pornstar Martini", "martini", "none", "vodka", 2, "香草伏特加^45ml;百香果利口酒^15ml;百香果泥^30ml;青柠汁^15ml;香槟^旁置", "百香果的奢华，配一小杯香槟"],
    ...
    ["梅斯卡尔骡子", "Mezcal Mule", "highball", "cube", "tequila", 1, "梅斯卡尔^45ml;青柠汁^15ml;姜啤^顶部补满", "烟熏版骡子，辛辣升级"],
    ["接骨木气泡", "Elderflower Spritz", "highball", "cube", "gin", 1, "金酒^30ml;接骨木花利口酒^20ml;普罗赛克^60ml;苏打水^少量", "花香气泡的轻盈开胃"],
    ["咖啡古典", "Coffee Old Fashioned", "rocks", "sphere", "whisky", 2, "波本威士忌^60ml;咖啡糖浆^10ml;咖啡苦精^2 dash;橙皮^1 片", "咖啡风味的古典进化"],
    ["黑刺李金菲兹", "Sloe Gin Fizz", "highball", "none", "wine", 1, "黑刺李金酒^45ml;柠檬汁^25ml;糖浆^15ml;苏打水^顶部补满", "黑刺李的莓果气泡，红宝石色"],
    ["肯塔基骡子", "Kentucky Mule", "highball", "cube", "whisky", 1, "波本威士忌^50ml;青柠汁^15ml;姜啤^顶部补满;薄荷^适量", "波本版骡子，姜与橡木的辛香"],
    ["龙舌兰日出", "Tequila Sunrise", "highball", "cube", "tequila", 1, "龙舌兰^45ml;橙汁^90ml;红石榴糖浆^15ml", "渐变日出色，橙汁与石榴的清晨"],
    ["海风", "Sea Breeze", "highball", "cube", "vodka", 1, "伏特加^45ml;蔓越莓汁^90ml;西柚汁^30ml", "蔓越莓与葡萄柚的海岸清风"],
    ["灰狗", "Greyhound", "highball", "cube", "vodka", 1, "伏特加^45ml;西柚汁^120ml", "葡萄柚的纯粹清爽，加盐即咸狗"],
  ...
  zero: [
    ["维珍莫吉托", "Virgin Mojito", "highball", "crushed", "absinthe", 1, "青柠汁^25ml;糖浆^20ml;薄荷叶^10 片;苏打水^顶部补满", "无酒精的薄荷青柠清凉"],
    ["秀兰邓波尔", "Shirley Temple", "highball", "cube", "campari", 1, "姜汁汽水^150ml;红石榴糖浆^15ml;樱桃^1 颗", "童年的甜美汽水，红石榴的玫红"],
    ["维珍椰林飘香", "Virgin Piña Colada", "highball", "crushed", "cream", 1, "菠萝汁^120ml;椰子奶油^45ml;鲜奶油^15ml", "椰子菠萝的热带奶昔，无酒精"],
    ["处女玛丽", "Virgin Mary", "highball", "cube", "campari", 1, "番茄汁^120ml;柠檬汁^15ml;辣酱^3 dash;伍斯特酱^2 dash;芹菜^1 根", "无酒精血腥玛丽，咸鲜开胃"],
    ["罗伊罗杰斯", "Roy Rogers", "highball", "cube", "campari", 1, "可乐^150ml;红石榴糖浆^15ml;樱桃^1 颗", "可乐版邓波尔，牛仔的汽水"],
    ["阿诺帕尔默", "Arnold Palmer", "highball", "cube", "default", 1, "红茶^90ml;柠檬水^90ml;柠檬片^1 片", "高尔夫名将之名，冰茶柠檬水各半"],
    ["灰姑娘", "Cinderella", "coupe", "none", "tequila", 1, "橙汁^45ml;菠萝汁^45ml;柠檬汁^15ml;苏打水^少量", "三果汁的午夜魔法，清甜活泼"],
    ["西园花园", "Seedlip Garden", "coupe", "none", "absinthe", 1, "无酒精金酒^50ml;接骨木花糖浆^15ml;柠檬汁^15ml;黄瓜片^3 片", "无酒精蒸馏的草本花园"],
    ["黄瓜清凉", "Cucumber Cooler", "highball", "cube", "absinthe", 1, "黄瓜汁^60ml;青柠汁^20ml;糖浆^15ml;苏打水^顶部补满;薄荷^适量", "黄瓜薄荷的盛夏冷饮"],
    ["姜味气泡", "Ginger Fizz", "highball", "cube", "tequila", 1, "姜汁糖浆^30ml;柠檬汁^20ml;苏打水^顶部补满;姜片^1 片", "辛辣生姜的清爽气泡"],
    ["接骨木气泡水", "Elderflower Soda", "highball", "cube", "absinthe", 1, "接骨木花糖浆^30ml;柠檬汁^15ml;苏打水^顶部补满;薄荷^适量", "花香气泡，优雅无酒精"],
    ["石榴气泡", "Pomegranate Fizz", "highball", "cube", "campari", 1, "石榴汁^60ml;青柠汁^20ml;糖浆^10ml;苏打水^顶部补满", "石榴的酸甜红宝石气泡"],
    ["热带潘趣", "Tropical Punch", "highball", "crushed", "tequila", 1, "菠萝汁^60ml;芒果汁^45ml;百香果糖浆^15ml;青柠汁^15ml", "群果热带潘趣，阳光满杯"],
    ["薰衣草柠檬水", "Lavender Lemonade", "highball", "cube", "default", 1, "柠檬汁^30ml;薰衣草糖浆^25ml;水^90ml;薰衣草^点缀", "薰衣草的花香柠檬水，舒缓宁静"],
    ["蜜桃冰茶", "Peach Iced Tea", "highball", "cube", "tequila", 1, "红茶^120ml;桃子糖浆^25ml;柠檬汁^15ml;桃片^1 片", "蜜桃浸润的冰红茶，夏日午后"],
    ["西瓜清凉", "Watermelon Cooler", "highball", "crushed", "campari", 1, "西瓜汁^90ml;青柠汁^20ml;糖浆^10ml;薄荷^适量", "西瓜的清甜多汁，碎冰沁凉"],
    ...
    ["苹果气泡", "Apple Spritz", "highball", "cube", "default", 1, "苹果汁^90ml;接骨木花糖浆^15ml;苏打水^顶部补满;苹果片^1 片", "青苹果的清脆气泡"],
    ["薄荷柠檬水", "Mint Lemonade", "highball", "crushed", "absinthe", 1, "柠檬汁^30ml;糖浆^25ml;水^90ml;薄荷叶^10 片", "捣碎薄荷的经典柠檬水"],
    ["洛神花清凉", "Hibiscus Cooler", "highball", "cube", "campari", 1, "洛神花茶^120ml;青柠汁^20ml;蜂蜜^15ml;苏打水^少量", "洛神花的玫红酸甜冷饮"],
    ["百香果气泡", "Passion Fizz", "coupe", "none", "tequila", 1, "百香果泥^45ml;橙汁^45ml;青柠汁^15ml;苏打水^少量", "百香果的酸香气泡"],
    ["椰子清凉", "Coconut Cooler", "highball", "crushed", "cream", 1, "椰子水^120ml;菠萝汁^45ml;青柠汁^15ml;薄荷^适量", "椰子水的轻盈补水热带"],
    ["香料苹果", "Spiced Apple", "rocks", "none", "whisky", 1, "苹果汁^120ml;肉桂糖浆^15ml;柠檬汁^15ml;肉桂棒^1 根", "温暖的香料苹果，秋日暖意"],
    ["蔓越莓气泡", "Cranberry Fizz", "highball", "cube", "campari", 1, "蔓越莓汁^90ml;青柠汁^20ml;糖浆^10ml;苏打水^顶部补满", "蔓越莓的酸涩气泡，节日红"],
    ["荔枝清凉", "Lychee Cooler", "coupe", "none", "default", 1, "荔枝汁^60ml;青柠汁^15ml;接骨木花糖浆^15ml;苏打水^少量", "荔枝的花香清甜"],
    ["柚子苏打", "Yuzu Soda", "highball", "cube", "tequila", 1, "柚子糖浆^30ml;柠檬汁^15ml;苏打水^顶部补满;柚子皮^1 片", "柚子的清新柑橘气泡"],
    ["抹茶汤力", "Matcha Tonic", "highball", "cube", "absinthe", 2, "抹茶^60ml;汤力水^顶部补满;蜂蜜^10ml;柠檬^1 片", "抹茶的微苦遇上汤力的清冽"],
    ["冷萃汤力", "Cold Brew Tonic", "highball", "cube", "whisky", 1, "冷萃咖啡^60ml;汤力水^90ml;橙皮^1 片", "冷萃咖啡的意外气泡，清爽提神"],
    ["生姜薄荷", "Ginger Mint", "highball", "crushed", "absinthe", 1, "姜汁糖浆^25ml;青柠汁^20ml;薄荷叶^8 片;苏打水^顶部补满", "生姜薄荷的双重清凉"],
    ["蓝莓罗勒", "Blueberry Basil", "coupe", "none", "wine", 1, "蓝莓泥^45ml;柠檬汁^20ml;糖浆^15ml;罗勒叶^4 片;苏打水^少量", "蓝莓与罗勒的现代无酒精"],
    ["玫瑰荔枝", "Rose Lychee", "coupe", "none", "default", 1, "荔枝汁^45ml;玫瑰糖浆^15ml;柠檬汁^15ml;苏打水^少量", "玫瑰荔枝的浪漫花香"],
    ["桂花乌龙", "Osmanthus Oolong", "highball", "cube", "whisky", 1, "乌龙茶^120ml;桂花糖浆^20ml;柠檬汁^10ml", "桂花乌龙的东方茶韵"],
    ["甜瓜薄荷", "Melon Mint", "highball", "crushed", "absinthe", 1, "哈密瓜汁^90ml;青柠汁^15ml;糖浆^10ml;薄荷^适量", "哈密瓜的清甜薄荷"],
    ["柑橘冷饮", "Citrus Cooler", "highball", "cube", "tequila", 1, "橙汁^45ml;西柚汁^45ml;柠檬汁^15ml;苏打水^顶部补满", "三柑橘的明亮维C冷饮"],
    ["维珍日出", "Virgin Sunrise", "highball", "cube", "tequila", 1, "橙汁^120ml;红石榴糖浆^15ml;青柠汁^15ml", "无酒精的日出渐变，清甜柑橘"],
    ["无酒精尼格罗尼", "No-groni", "rocks", "cube", "campari", 2, "无酒精苦味^30ml;无酒精金酒^30ml;无酒精味美思^30ml;橙皮^1 片", "苦甜平衡的无酒精尼格罗尼"],
    ["莓果柠檬水", "Berry Lemonade", "highball", "crushed", "campari", 1, "草莓泥^45ml;柠檬汁^25ml;糖浆^15ml;水^90ml", "草莓柠檬水的盛夏粉红"],
    ["姜青柠苏打", "Ginger Lime Soda", "highball", "cube", "absinthe", 1, "姜汁糖浆^25ml;青柠汁^20ml;苏打水^顶部补满;青柠片^1 片", "姜与青柠的清爽气泡"],
    ["热带落日", "Tropical Sunset", "highball", "crushed", "campari", 1, "芒果汁^60ml;百香果糖浆^15ml;蔓越莓汁^45ml;青柠汁^15ml", "芒果与蔓越莓的落日渐变"],
    ["青葡萄气泡", "Verjus Spritz", "highball", "cube", "wine", 1, "未熟葡萄汁^45ml;接骨木花糖浆^15ml;苏打水^顶部补满;薄荷^适量", "青葡萄的酸爽气泡开胃"],
  ],
};

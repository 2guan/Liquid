...
const RAW: Record<RecipeCategory, Row[]> = {
  ...
  zero: [
    ...
    ["黄瓜清凉", "Cucumber Cooler", "highball", "cube", "gin", 1, "黄瓜汁^60ml;青柠汁^20ml;糖浆^15ml;苏打水^顶部补满;薄荷^适量", "黄瓜薄荷的盛夏冷饮"],
    ["姜味气泡", "Ginger Fizz", "highball", "cube", "vodka", 1, "姜汁糖浆^30ml;柠檬汁^20ml;苏打水^顶部补满;姜片^1 片", "辛辣生姜的清爽气泡"],
    ["接骨木气泡水", "Elderflower Soda", "highball", "cube", "gin", 1, "接骨木花糖浆^30ml;柠檬汁^15ml;苏打水^顶部补满;薄荷^适量", "花香气泡，优雅无酒精"],
    ...
    ["薰衣草柠檬水", "Lavender Lemonade", "highball", "cube", "vodka", 1, "柠檬汁^30ml;薰衣草糖浆^25ml;水^90ml;薰衣草^点缀", "薰衣草的花香柠檬水，舒缓宁静"],
    ...
    ["柚子苏打", "Yuzu Soda", "highball", "cube", "vodka", 1, "柚子糖浆^30ml;柠檬汁^15ml;苏打水^顶部补满;柚子皮^1 片", "柚子的清新柑橘气泡"],
    ...
    ["柑橘冷饮", "Citrus Cooler", "highball", "cube", "vodka", 1, "橙汁^45ml;西柚汁^45ml;柠檬汁^15ml;苏打水^顶部补满", "三柑橘的明亮维C冷饮"],
    ...
    ["姜青柠苏打", "Ginger Lime Soda", "highball", "cube", "vodka", 1, "姜汁糖浆^25ml;青柠汁^20ml;苏打水^顶部补满;青柠片^1 片", "姜与青柠的清爽气泡"],

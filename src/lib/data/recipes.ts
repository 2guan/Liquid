...
const RAW: Record<RecipeCategory, Row[]> = {
  golden: [
    ...
    ["金菲兹", "Gin Fizz", "highball", "cube", "gin", 2, "金酒^45ml;柠檬汁^25ml;糖浆^15ml;蛋白^1 个;苏打水^顶部补满", "云雾般绵密，柠檬与气泡的清晨"],
  ...
  modern: [
    ...
    ["长岛冰茶", "Long Island Iced Tea", "highball", "cube", "default", 2, "伏特加^15ml;金酒^15ml;白朗姆^15ml;龙舌兰^15ml;君度橙酒^15ml;柠檬汁^22ml;可乐^顶部补满", "五烈酒伪装的茶色，强劲危险"],
    ...
    ["梅斯卡尔骡子", "Mezcal Mule", "highball", "cube", "whiskyPeat", 1, "梅斯卡尔^45ml;青柠汁^15ml;姜啤^顶部补满", "烟熏版骡子，辛辣升级"],
    ...
    ["黑刺李金菲兹", "Sloe Gin Fizz", "highball", "cube", "wine", 1, "黑刺李金酒^45ml;柠檬汁^25ml;糖浆^15ml;苏打水^顶部补满", "黑刺李的莓果气泡，红宝石色"],
  ...
  zero: [
    ["维珍莫吉托", "Virgin Mojito", "highball", "crushed", "default", 1, "青柠汁^25ml;糖浆^20ml;薄荷叶^10 片;苏打水^顶部补满;青柠角^1 块", "无酒精的薄荷青柠清凉"],
    ...
    ["处女玛丽", "Virgin Mary", "highball", "cube", "default", 1, "番茄汁^120ml;柠檬汁^15ml;辣酱^3 dash;伍斯特酱^2 dash;芹菜^1 根", "无酒精血腥玛丽，咸鲜开胃"],
    ["罗伊罗杰斯", "Roy Rogers", "highball", "cube", "default", 1, "可乐^150ml;红石榴糖浆^15ml;樱桃^1 颗", "可乐版邓波尔，牛仔的汽水"],
    ...
    ["黄瓜清凉", "Cucumber Cooler", "highball", "cube", "default", 1, "黄瓜汁^60ml;青柠汁^20ml;糖浆^15ml;苏打水^顶部补满;薄荷^适量", "黄瓜薄荷的盛夏冷饮"],
    ["姜味气泡", "Ginger Fizz", "highball", "cube", "default", 1, "姜汁糖浆^30ml;柠檬汁^20ml;苏打水^顶部补满;姜片^1 片", "辛辣生姜的清爽气泡"],
    ["接骨木气泡水", "Elderflower Soda", "highball", "cube", "default", 1, "接骨木花糖浆^30ml;柠檬汁^15ml;苏打水^顶部补满;薄荷^适量", "花香气泡，优雅无酒精"],
    ...
    ["蜜桃冰茶", "Peach Iced Tea", "highball", "cube", "wine", 1, "红茶^120ml;桃子糖浆^25ml;柠檬汁^15ml;桃片^1 片", "蜜桃浸润的冰红茶，夏日午后"],
    ...
    ["荔枝清凉", "Lychee Cooler", "highball", "none", "default", 1, "荔枝汁^60ml;青柠汁^15ml;接骨木花糖浆^15ml;苏打水^少量", "荔枝的花香清甜"],
    ["柚子苏打", "Yuzu Soda", "highball", "cube", "default", 1, "柚子糖浆^30ml;柠檬汁^15ml;苏打水^顶部补满;柚子皮^1 片", "柚子的清新柑橘气泡"],
    ["抹茶汤力", "Matcha Tonic", "highball", "cube", "default", 2, "抹茶^60ml;汤力水^顶部补满;蜂蜜^10ml;柠檬^1 片", "抹茶的微苦遇上汤力的清冽"],
    ["冷萃汤力", "Cold Brew Tonic", "highball", "cube", "default", 1, "冷萃咖啡^60ml;汤力水^90ml;橙皮^1 片", "冷萃咖啡的意外气泡，清爽提神"],
    ["生姜薄荷", "Ginger Mint", "highball", "crushed", "default", 1, "姜汁糖浆^25ml;青柠汁^20ml;薄荷叶^8 片;苏打水^顶部补满", "生姜薄荷的双重清凉"],
    ...
    ["桂花乌龙", "Osmanthus Oolong", "highball", "cube", "wine", 1, "乌龙茶^120ml;桂花糖浆^20ml;柠檬汁^10ml", "桂花乌龙的东方茶韵"],
    ["甜瓜薄荷", "Melon Mint", "highball", "crushed", "default", 1, "哈密瓜汁^90ml;青柠汁^15ml;糖浆^10ml;薄荷^适量", "哈密瓜的清甜薄荷"],
    ["柑橘冷饮", "Citrus Cooler", "highball", "cube", "default", 1, "橙汁^45ml;西柚汁^45ml;柠檬汁^15ml;苏打水^顶部补满", "三柑橘的明亮维C冷饮"],
    ["维珍日出", "Virgin Sunrise", "highball", "cube", "default", 1, "橙汁^120ml;红石榴糖浆^15ml;青柠汁^15ml", "无酒精的日出渐变，清甜柑橘"],
    ...
    ["姜青柠苏打", "Ginger Lime Soda", "highball", "cube", "default", 1, "姜汁糖浆^25ml;青柠汁^20ml;苏打水^顶部补满;青柠片^1 片", "姜与青柠的清爽气泡"],

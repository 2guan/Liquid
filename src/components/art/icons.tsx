...
/**
 * Line-art icon set in the engraved-gold style. 24×24, stroke = currentColor.
 * Keep every glyph to thin strokes with round caps to read as etched brass.
 */
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  library: (
    <>
      <path d="M6 3h3v18H6zM6 7h3" />
      <path d="M11 3h3v18h-3zM11 8h3" />
      <path d="M16.4 4.6l2.9.8 1.7 15.2-3.6.6z" />
    </>
  ),
  journal: (
    <>
      <path d="M5 4h9a3 3 0 0 1 3 3v13H8a3 3 0 0 1-3-3z" />
      <path d="M17 7a3 3 0 0 1 3-3h0v13M9 8h5M9 11h5" />
    </>
  ),
  trophy: (
    <>
      <path d="M7 4h10v4a5 5 0 0 1-10 0z" />
      <path d="M7 5H4v1a3 3 0 0 0 3 3M17 5h3v1a3 3 0 0 1-3 3M9 19h6M10 16h4v3h-4z" />
    </>
  ),
  settings: (
    <>
  ...
  sparkle: (
    <path d="M12 3l1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8zM18 15l.9 2.1L21 18l-2.1.9L18 21l-.9-2.1L15 18l2.1-.9z" />
  ),
  lock: (
    <>
  ...
  snow: (
    <path d="M12 3v18M4.5 7.5l15 9M19.5 7.5l-15 9M12 6l-2.2-2M12 6l2.2-2M12 18l-2.2 2M12 18l2.2 2" />
  ),
  search: (
    <>
